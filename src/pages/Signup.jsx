...
// //function to store user data in firestore database
...
//     try {
//       const userCredential = await register(email, password); // Register user
...
//         <h2 className="text-2xl font-bold text-center text-indigo-700 mb-4">Create Your Account</h2>
